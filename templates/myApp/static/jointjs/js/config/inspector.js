...
/*    alert("2222");*/
    ...
    var options = {
        ...
        colorPalette: [
            { content: 'transparent', icon: 'static/jointjs/assets/transparent-icon.svg' },
            { content: '#f6f6f6' },
            { content: '#dcd7d7' },
            { content: '#8f8f8f' },
            { content: '#c6c7e2' },
        ...
        colorPaletteReset: [
            { content: undefined, icon: 'static/jointjs/assets/no-color-icon.svg' },
            { content: '#f6f6f6' },
            { content: '#dcd7d7' },
            { content: '#8f8f8f' },
            { content: '#c6c7e2' },
        ...
        imageIcons: [
            ...
            { value: 'static/jointjs/assets/image-icon2.svg', content: '<img height="80px" src="static/jointjs/assets/image-icon2.svg"/>' },
            { value: 'static/jointjs/assets/image-icon1.svg', content: '<img height="42px" src="static/jointjs/assets/image-icon1.svg"/>' },
            { value: 'static/jointjs/assets/image-icon3.svg', content: '<img height="80px" src="static/jointjs/assets/image-icon3.svg"/>' },
            { value: 'static/jointjs/assets/image-icon4.svg', content: '<img height="80px" src="static/jointjs/assets/image-icon4.svg"/>' }
        ],

        imageGender: [
            { value: 'static/jointjs/assets/member-male.png', content: '<img height="50px" src="static/jointjs/assets/member-male.png" style="margin: 5px 0 0 2px;"/>' },
            { value: 'static/jointjs/assets/member-female.png', content: '<img height="50px" src="static/jointjs/assets/member-female.png" style="margin: 5px 0 0 2px;"/>' }
        ],
